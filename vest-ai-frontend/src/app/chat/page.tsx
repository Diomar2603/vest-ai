      ...
      >
        ...
        <div className="flex-1 py-4">
          <nav className="space-y-1 px-2">
            <Link href="/chat" className="flex items-center gap-3 px-3 py-2 rounded-md bg-sidebar-accent text-sidebar-accent-foreground">
            ...
            <Link href="/community" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-sidebar-accent/50 text-sidebar-foreground">
              <Users className="h-5 w-5" />
              {isSidebarOpen && <span>Comunidade</span>}
            </Link>
